...
regular_beam=20 # beam used after the first iteration
retry_beam=40
...
feats="ark,s,cs:copy-feats scp:$sdata/JOB/feats.scp ark:- | add-deltas $delta_opts ark:- ark:- |"
...
show-alignments $lang/phones.txt $dir/final.mdl "ark:gunzip -c $dir/ali.0.gz|" | head -4
